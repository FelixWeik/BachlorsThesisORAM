...
df_nit_128 = pd.DataFrame({
    "x": [x1,x2,x3,x4,x5,x6,x7],
    "y": [0.071,0.068,0.074,0.069,0.215,1.344,1.784],
    "Approach": "new_input_type 128 bit"
})

df_nit_256 = pd.DataFrame({
    "x": [x1,x2,x3,x4,x5,x6,x7],
    "y": [0.152,0.144,0.149,0.15,0.344,1.521,1.908],
...
df_nit_64 = pd.DataFrame({
    "x": [x1,x2,x3,x4,x5,x6,x7],
    "y": [0.039,0.041,0.042,0.046,0.096,1.108,2.681],
    "Approach": "new_input_type 64 bit"
})

df_nit_128 = pd.DataFrame({
    "x": [x1,x2,x3,x4,x5,x6,x7],
    "y": [0.052,0.049,0.052,0.049,0.146,1.308,2.981],
    "Approach": "new_input_type 128 bit"
})

df_nit_256 = pd.DataFrame({
    "x": [x1,x2,x3,x4,x5,x6,x7],
    "y": [0.091,0.086,0.093,0.091,0.231,1.49,3.205],
    "Approach": "new_input_type 256 bit"
})
