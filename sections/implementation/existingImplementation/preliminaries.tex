...
Labels are stored as \code{\_\_m128i}, leafs as concatenations of 64-bit values.
...
It is, however, not compatible for using SIMD datatypes which triggers an error message and ultimately stops program execution.
This makes debugging tedious and unnecessarily hard.
...
It provides basic functions for reading and updating the duoram.
...
This reduces the overhead to a minimum.
