This theoretical analysis is based on the reading and writing protocol from \ref{sub:AdvancedReadingAndWriting} taken from Vadapalli et al. \cite{vadapalli2023duoram}.

\subsection*{General Assumptions} \label{subsub:ScalingInTheoryGeneralAssumptions}
...
\subsection*{Scaling during Preprocessing} \label{subsub:ScalingDuringPreprocessing}
...
\subsection*{Online-Phase Scaling} \label{subsub:ScalingDuringOnlinePhase}
