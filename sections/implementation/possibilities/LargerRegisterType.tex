...
Note that scaling \code{DPFNode} will automatically scale \code{LeafNode} as well.
...
This means updating the context will also use a new set of RDPF-Triples.
Therefore, for every new operation on the database, this approach will use a fresh set of RDPF-Triples.
