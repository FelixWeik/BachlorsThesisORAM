...
\textit{DUORAM} uses (2,2)-DPFs (\ref{sub:DistributedPointFunctions}) to represent \textit{Private Information Retrieval (PIR)} and PIR-Writing queries (\ref{sub:PrivateInformationRetreival}).
