...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{plots/plots/online/wct_latency_read_online.png}
...
\begin{figure}
    \centering 
    \includegraphics[width=\textwidth]{plots/plots/online/wct_latency_update_online.png}
...
\textit{new\_input\_type} sends fewer messages compared to \textit{gmp\_mpz\_class} on the same bit size.
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{plots/plots/online/wct_bandwidth_read_online.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{plots/plots/online/wct_bandwidth_update_online.png}
...
\begin{figure}
    \centering 
    \includegraphics[width=\textwidth]{plots/plots/online/message_num_read_online.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{plots/plots/online/message_num_update_online.png}
